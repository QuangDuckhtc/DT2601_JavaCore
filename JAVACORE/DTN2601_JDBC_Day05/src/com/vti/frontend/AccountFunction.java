...
public class AccountFunction {
    ...
    private static QLAccount qlAccount = new QLAccount();
    ...
    public static void insert() {
        ...
        boolean result = qlAccount.insertAccount(email, username, fullName, depId, posId);
    ...
    public static void update() {
        ...
        boolean result = qlAccount.updateAccount(id, fullName);
    ...
    public static void delete() {
        ...
        boolean result = qlAccount.deleteAccount(email);
